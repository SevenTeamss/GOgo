...
<fieldset>
	...
	<label class="block clearfix">
		<span class="block input-icon input-icon-right">
			<input type="password" name='user_pwd' class="form-control" placeholder="User_pwd" />
			<i class="icon-lock"></i>
		</span>
	</label>
	...
	<div class="clearfix">
		<label class="inline">
			<input type="checkbox" class="ace" name='is_check' value="1" />
...
<div>
<a href="index.php?r=user/forget"  class="forgot-password-link">
...
<div>
<a href="index.php?r=user/zhu"  class="user-signup-link">
	注册
